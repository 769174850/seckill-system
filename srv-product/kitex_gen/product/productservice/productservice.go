...
func getProductHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(product.ProductService).GetProduct(ctx, realArg.P)
	if err != nil {
		return err
	}
...
func (p *kClient) GetProduct(ctx context.Context, p_ *product.Product) (r *product.Product, err error) {
